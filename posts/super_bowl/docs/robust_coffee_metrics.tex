...
\begin{center}
\url{https://github.com/sillyplots/mosp/blob/main/posts/super_bowl/README.md}
\end{center}
...
\begin{itemize}
    \item \href{https://github.com/sillyplots/mosp/blob/main/posts/super_bowl/etl/load_data.py}{\texttt{etl/load\_data.py}} -- Loads nflverse PBP data to BigQuery
    \item \href{https://github.com/sillyplots/mosp/blob/main/posts/super_bowl/etl/scrape_coffee_locations.py}{\texttt{etl/scrape\_coffee\_locations.py}} -- Scrapes coffee locations via Google Maps API
\end{itemize}

\noindent \textbf{Analysis \& Visualization:}
\begin{itemize}
    \item \href{https://github.com/sillyplots/mosp/blob/main/posts/super_bowl/analysis/robust_coffee_check.py}{\texttt{analysis/robust\_coffee\_check.py}} -- Main analysis script
    \item \href{https://github.com/sillyplots/mosp/blob/main/posts/super_bowl/analysis/reproduce_robust_metrics.sql}{\texttt{analysis/reproduce\_robust\_metrics.sql}} -- Reproducible SQL queries
    \item \href{https://github.com/sillyplots/mosp/blob/main/posts/super_bowl/visualization/generate_map.py}{\texttt{visualization/generate\_map.py}} -- Interactive gravity field map
    \item \href{https://github.com/sillyplots/mosp/blob/main/posts/super_bowl/visualization/plot_gravity_chart.py}{\texttt{visualization/plot\_gravity\_chart.py}} -- Net gravity ranking chart
\end{itemize}
