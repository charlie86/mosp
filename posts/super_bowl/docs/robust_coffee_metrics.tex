...
\noindent Key scripts:
\begin{itemize}
    \item \href{https://github.com/charlie86/mosp/blob/main/posts/super_bowl/visualization/generate_map.py}{\texttt{visualization/generate\_map.py}} -- Interactive map generation
    \item \href{https://github.com/charlie86/mosp/blob/main/posts/super_bowl/analysis/robust_coffee_check.py}{\texttt{analysis/robust\_coffee\_check.py}} -- Data extraction \& analysis
