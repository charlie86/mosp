...
All findings in this paper are reproducible using the provided codebase:
\begin{itemize}
    \item \texttt{robust\_coffee\_check.py}: End-to-end extraction and gravity calculation.
    \item \texttt{reproduce\_robust\_metrics.sql}: Standalone SQL for replication.
\end{itemize}
